...
- `InngageSDK` extends `ChangeNotifier` and exposes a deprecated `notificationController` **only for backward compatibility** — neither ever emits anything. Both are slated for removal in 4.0 (see `doc/V4_API_DESIGN.md`).
